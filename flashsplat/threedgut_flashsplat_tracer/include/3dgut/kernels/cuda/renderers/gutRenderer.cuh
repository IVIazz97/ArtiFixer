...
__global__ void render(threedgut::RenderParameters params,
    ...
    TGUTRenderer::eval(params,
                       ...
                       particlesPrecomputedFeaturesPtr,
                       {parameterMemoryHandles},
                       /*particlesProjectedPositionGradPtr=*/nullptr,
                       /*particlesProjectedConicOpacityGradPtr=*/nullptr,
                       /*particlesGlobalDepthGradPtr=*/nullptr,
                       /*particlesPrecomputedFeaturesGradPtr=*/nullptr,
                       /*parametersGradient=*/{},
                       flashSplat);
